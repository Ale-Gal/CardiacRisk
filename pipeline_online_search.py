...
if __name__=='__main__':
    ...
    X_labels=['SEX','Age','Enrl','Diabetes', 'Hypercholesterolemia', 'Hypertension', 'Smoking','CCS>II','DEP ST','SBP','HR','KILLIP','TN','Creat','CAA','AAS','Angina', 'MI', 'MR', 'PTCA', 'CABG'] #classi 'RF' e 'Kn. CAD' rimpiazzate dai singoli val che le costituiscono; 'DEP ST'=Depression Segment non è presente nella mia modellazione dei pz; attrib 'Aspirina' e 'ST SegmDev' sono inutilizzati; 'AAS'=Acute Aortic Syndrome non è presente nella mia modellazione dei pz.
